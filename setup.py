...
integration_str = "tera" # This could change to hive, drill, elastic etc.
...
setup_args = dict(
    ...
    long_description="A magic function for working with Teradata for Python3 based Jupyter Notebooks",
    author="John Omernik",
